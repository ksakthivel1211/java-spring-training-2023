...
public class AdminController {
    ...
    public ResponseEntity<ControllerResponse> deleteTheatre(@RequestParam String theatreName)
    {
        return ResponseEntity.status(HttpStatus.OK).body(adminService.deleteTheatre(theatreName));
    }
